...
for each_image in sorted_images:
    ...
    if substring in result or pastern in result:
        cv2.imwrite(rf'C:\Users\nharw\PycharmProjects\pdf2AnkiVersion2\solutionsFinal\{answer_counter}.jpg', img)
        answer_counter += 1

    else:
        cv2.imwrite(rf'C:\Users\nharw\PycharmProjects\pdf2AnkiVersion2\solutionsFinal\{answer_counter}.jpg', img)
        prev_image = cv2.imread(
            rf'C:\Users\nharw\PycharmProjects\pdf2AnkiVersion2\solutionsFinal\{answer_counter-1}.jpg', 0) # "-1" is important
        curr_image = cv2.imread(rf'C:\Users\nharw\PycharmProjects\pdf2AnkiVersion2\solutionsFinal\{answer_counter}.jpg', 0)
        ...
        cv2.imwrite(rf'C:\Users\nharw\PycharmProjects\pdf2AnkiVersion2\solutionsFinal\{file_name}', combined_solution)
